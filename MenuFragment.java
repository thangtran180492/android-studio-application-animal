...
public class MenuFragment extends Fragment {
    ...
    private void initView(View v) {
        ...
        ImageView ivLogoMenu = v.findViewById(R.id.iv_logo_menu);
        ivLogoMenu.setImageBitmap(getRes(R.drawable.ic_logo, 300, 300));
     ...
     * @param  animalType chỉ định tên mục để thao tác */
     ...
     * @param options thông tin của ảnh
     * @param reqWidth chiều rộng tối đa
     * @param reqHeight chiều cao tối đa
     * */
    ...
    /** giảm kích cỡ file
     * @param path đường dẫn ảnh assets
     * @param reqWidth chiều rộng tối đa yêu cầu
     * @param reqHeight chiều cao tối đa yêu cầu
     * */
